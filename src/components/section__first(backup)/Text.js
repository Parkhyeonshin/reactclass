    ...
    return (
        <>
            <section id="textType" className={`text__wrap ${attr[0]} ${attr[1]} `}>
                ...
                <h2 className="mb70">ABOUT US</h2>
                <div className={`text__inner ${attr[2]}`}>
                    <div className="text t1">
                        <h3 className="text__title">글루텐 프리</h3>
                        <p className="text__desc">
                            알레르기를 유발할 수 있는 글루텐을 넣지 않음으로써, 남녀노소 모두가 쓸 수 있는 향수를
                            만듭니다.
                        </p>
                    ...
                    <div className="text t2">
                        ...
                        <p className="text__desc">
                            끗한 향수를 만들어 믿고 사용할 수 있는 제품을 만드는데 힘쓰고 있습니다. 친환경 원료만
                            사용해서 만든 대표적인 비건 향수입니다.
                        </p>
                        <a className="text_btn" href="/">
                            더보기
                        </a>
                    ...
                    <div className="text t3">
                        ...
                        <p className="text__desc">
                            동물 실험을 거치지 않고 만들어지는 향수입니다. 생명을 소중히 하며 윤리적인 기업이 되고자
                            노력하고 있습니다.
                        </p>
                        <a className="text_btn" href="/">
                            더보기
                    ...
                    <div className="text t4">
                        ...
                        <p className="text__desc">
                            자연을 침해하지 않는 범위 내에서 만들어진 클린의 제품들은 사용 후 다시 그대로 자연으로
                            돌아가는 전제품 ‘리사이클러블’을 추구하고 있습니다.
                        </p>
                        <a className="text_btn" href="/">
                            더보기
                        </a>
